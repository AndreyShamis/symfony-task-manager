...
use Werd\IotBundle\Entity\Test;
...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tests = $em->getRepository('IotBundle:Test')->findAll();
    ...
    {
        $test = new Test();
        $form = $this->createForm('Werd\IotBundle\Form\TestType', $test);
    ...
    {
        $deleteForm = $this->createDeleteForm($test);
        $editForm = $this->createForm('Werd\IotBundle\Form\TestType', $test);
