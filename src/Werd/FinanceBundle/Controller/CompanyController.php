...
use Werd\FinanceBundle\Entity\Company;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $companies = $em->getRepository('WerdFinanceBundle:Company')->findAll();
    ...
    {
        $company = new Company();
        $form = $this->createForm('Werd\FinanceBundle\Form\CompanyType', $company);
    ...
    {
        $deleteForm = $this->createDeleteForm($company);
        $editForm = $this->createForm('Werd\FinanceBundle\Form\CompanyType', $company);
