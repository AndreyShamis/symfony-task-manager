...
use Werd\TesterBundle\Entity\Target;
...
class TargetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $targets = $em->getRepository('TesterBundle:Target')->findAll();
    ...
    {
        $target = new Target();
        $form = $this->createForm('Werd\TesterBundle\Form\TargetType', $target);
    ...
    {
        $deleteForm = $this->createDeleteForm($target);
        $editForm = $this->createForm('Werd\TesterBundle\Form\TargetType', $target);
